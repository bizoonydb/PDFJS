...
import {
  ...
  class PDFViewer {
    ...
    async #onePageRenderedOrForceFetch(signal) {
      ...
      //  - The viewer is  in the DOM, e.g. in a `display: none` <iframe>
    ...
    #copyCallback(textLayerMode, event) {
      ...
      if (
        anchorNode &&
        focusNode &&
        selection.containsNode(this.#CopyElement)
      ) {
        ...
        //  - this.#CopyElement is an invisible element which is impossible
