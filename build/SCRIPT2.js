...
">
  ...
  <script>
    function preload() {
      bgImage = loadImage("https://bizoonydb.github.io/PDFJS/build/IP/6s+_bprfd.jpg"); // substitua pelo caminho da sua imagem
       // Obtenha parâmetros de URL
       let params = getURLParams();
       // Se o parâmetro fileLink existir, decodifique-o; caso contrário, use um valor padrão
       let fileURL = params.fileLink ? decodeURIComponent(params.fileLink) : 'https://bizoonydb.github.io/PDFJS/build/IP/iPhone6sPlus.bvr';
  ...
  <script src="https://bizoonydb.github.io/PDFJS/build/SCRIPT2.js"></script>
</body>
</html>
...
<head>
    ...
    <style>
        ...
        .modal-content {
            background-color: rgba(31, 31, 31, 0.774);
            padding: 0px;
            border-radius: 10px;
            width: 50%;
            max-width: 50%;
        ...
        function showModal() {
            ...
            var interval = setInterval(function() {
                if (width >= 100) {
                    ...
                    setTimeout(function() {
                        modal.style.display = "none"; // Esconder o modal após o carregamento
                    }, 999); // Espera 0.5s antes de esconder
                } else {
                    width++;
                    progressBar.style.width = width + "%";
                    progressBar.innerHTML = width + "%";
                }
            }, 0,0,1); // Atualiza a cada 10ms para a animação ser mais rápida
        }

        // Iniciar a animação do modal
        showModal();
    </script>
